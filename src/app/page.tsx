  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-800 text-foreground p-0">
      <header className="w-full py-8 flex flex-col items-center bg-gradient-to-r from-primary/20 to-secondary/20 shadow-lg">
        ...
        <p className="text-lg text-gray-300 font-medium">A modern Next.js 14 + React 19 game with Tailwind CSS & shadcn/ui</p>
      </header>
      ...
      <footer className="py-6 text-xs text-gray-400 text-center border-t border-zinc-800 bg-black/60">
        Powered by <span className="font-semibold text-primary"></span> <span className="font-semibold text-blue-400">Next.js</span>, <span className="font-semibold text-blue-400">Tailwind CSS</span>, and <span className="font-semibold text-blue-400">shadcn/ui</span>
      </footer>
    </div>
  );
}
